...
- ⚡ **Hybrid Parsing Engine** — Seamlessly switches between engines for optimal performance. All engines support **Targeted Snippet Parsing**, which intelligently selects wrapping strategies based on your `kind`, `async`, or `generator` hints. It automatically skips irrelevant strategies (like generator wrappers when parsing a standard function) to ensure maximum performance and accuracy.
